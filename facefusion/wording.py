WORDING =\
{
	'python_not_supported': 'Версия Python не поддерживается, обновите до {версии} или выше',
	'ffmpeg_not_installed': 'FFMpeg не установлен',
	'install_dependency_help': 'Выберите вариант {зависимость} для установки',
	'skip_venv_help': 'Пропустите проверку виртуальной среды',
	'source_help': 'Выберите исходное изображение',
	'target_help': 'Выберите картинку или видео, на которром будет осуществляться замена',
	'output_help': 'Укажите выходной файл или каталог',
	'frame_processors_help': 'Выберите один из доступных процессоров обработки кадров (варианты: {варианты}, ...)',
	'frame_processor_model_help': 'выберите модель для процессора frame processor',
	'frame_processor_blend_help': 'укажите количество наложения для обработчика кадров',
	'face_debugger_items_help': 'укажите элементы отладчика face (варианты выбора: {варианты выбора})',
	'ui_layouts_help': 'выберите один из доступных макетов пользовательского интерфейса (варианты: {варианты выбора}, ...)',
	'keep_fps_help': 'сохраняйте количество кадров в секунду (fps) целевого изображения',
	...
	'reference_face_gallery_label': 'Целевое лицо',
	'reference_face_distance_slider_label': 'Дистанция целевого лица',
	...
	'output_path_textbox_label': 'Выходной путь',
	'output_image_quality_slider_label': 'Выходное качество изображения',
	'output_video_encoder_dropdown_label': 'OUTPUT VIDEO ENCODER',
	'output_video_quality_slider_label': 'OUTPUT VIDEO QUALITY',
	'preview_image_label': 'Превью',
	'preview_frame_slider_label': 'Кадр превью',
	...
	'source_file_label': 'Ваше лицо',
	'target_file_label': 'Лицо-цель',
	'webcam_image_label': 'Веб-камера',
	'webcam_mode_radio_label': 'Режим веб-камеры',
